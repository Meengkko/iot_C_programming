...
byte Heart[] = {B10011001,B00000000,B00000000,B00000000,B10000001,B11000011,B11100111,B11111111};
...
if(timeCount <  TIME_DELAY) 
{
drawScreen(I);
} 
else if (timeCount <  TIME_DELAY * 2) 
{
drawScreen(L);
} 
else if (timeCount <  TIME_DELAY * 3) 
{
drawScreen(O);
} 
else if (timeCount <  TIME_DELAY * 4) 
{
drawScreen(V);
} 
else if (timeCount <  TIME_DELAY * 5) 
{
drawScreen(E);
} 
else if (timeCount <  TIME_DELAY * 6) 
{
drawScreen(Y);
} 
else if (timeCount <  TIME_DELAY * 7)
{
  drawScreen(O);
} 
else if (timeCount <  TIME_DELAY * 8) 
{
  drawScreen(U);
} 
else if (timeCount <  TIME_DELAY * 9) 
{
  drawScreen(Heart);
}
else if (timeCount <  TIME_DELAY * 10) 
{
drawScreen(ALL);
} 
else {
